...
const AllRooms = () => {
  ...
  //Function to check of a room matches the selected price ranges
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-grat-500/90 mt-2">
            Take advantage og our limited-time offers and special packages to
