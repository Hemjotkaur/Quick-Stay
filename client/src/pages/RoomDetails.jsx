...
const RoomDetails = () => {
  ...
  // check of the room is available
  const checkAvailability = async () => {
    try {
      // check is cehck-in date is greater than cehcko-out date
      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            You get the confortable two bedroom apartment that has a true city
            feeling.
          </p>
        </div>
        <div className="flex flex-col items-start gap-4">
          <div className="flex gap-4">
            <img
              ...
              onError={(e) => {
                e.target.src = "https://ui-avatars.com/api/?name=Host";
              }}
              alt="Host"
